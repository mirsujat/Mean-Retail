...
exports = module.exports = function(app, passport) {
  ...
  //social login
  app.get('/login/facebook', passport.authenticate('facebook', { callbackURL: 'http://localhost:8080/login/facebook/callback', scope: ['email'] }));
  app.get('/login/facebook/callback', useAngular);
  app.get('/login/google', passport.authenticate('google', { callbackURL: 'http://localhost:8080/login/google/callback', scope: ['profile email'] }));
  ...
  app.get('/account/settings/facebook/', passport.authenticate('facebook', { callbackURL: 'http://localhost:8080/account/settings/facebook/callback', scope: [ 'email' ]}));
  app.get('/account/settings/facebook/callback', useAngular);
  app.get('/account/settings/google/', passport.authenticate('google', { callbackURL: 'http://localhost:8080/account/settings/google/callback', scope: ['profile email'] }));
